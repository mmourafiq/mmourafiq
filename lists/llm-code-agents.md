---
layout: lists
title: "LLM agents and platforms"
tags: [ llm, agents ]
---

- [E2B](https://github.com/e2b-dev/e2b) — Open source platform for hosting LLM-based agents. Supports [Smol Developer](https://github.com/smol-ai/developer).
...
- [SuperAGI](https://github.com/TransformerOptimus/SuperAGI) Open source platform for hosting LLM-based agents including [SuperCoder](https://superagi.com/supercoder/).
...
- [Factory](https://www.factory.ai/) — Agents for code generation.
